   ...
   * false (default) - URL parameters are allowed to modify the function of the program */
   ...
   zones: {
     default: [ // The default zone configuration.
       ...
       {
         name: 'MiddleRightRight',
         type: 'right',
         coords: [[-160, 190], [-260, 290]],
         detect: ["rightWrist"],
         trigger: function() {},
         start: function() {},
         stop: function() {}
   ...
   keypointColor: "#ff0000", // Default color keypoints are drawn in. Default: #ffffff (white)
   skeletonColor: "#ff0000", // Default color the skeleton is drawn in. Default: #ffffff (white)
